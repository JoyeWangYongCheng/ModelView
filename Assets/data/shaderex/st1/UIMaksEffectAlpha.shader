            ...
            fixed4 frag(v2f IN) : SV_Target
            {
             ...
             //   #ifdef UNITY_UI_ALPHACLIP
              ...
              //  #endif
                ...
                vfx.a = 1;
                fixed4 rlt = lerp(_BackGroundColor+edgeC.xxxx*(mask)*fixed4(0.5,0.5,0.5,1),fixed4(color.xyz,_MainTexOpaque),max(0,(_Threshold-0.5)*2));
                return lerp(rlt,vfx+rlt,maskV);
            }
        ENDCG
        }
    }
