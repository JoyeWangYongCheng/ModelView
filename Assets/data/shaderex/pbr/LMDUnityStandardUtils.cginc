...
half4 lmd_unity_SHAr;
half4 lmd_unity_SHAg;
half4 lmd_unity_SHAb;
half4 lmd_unity_SHBr;
half4 lmd_unity_SHBg;
half4 lmd_unity_SHBb;
half4 lmd_unity_SHC;
...
half3 LMDSHEvalLinearL0L1(half4 normal)
{
	...
	x.r = dot(lmd_unity_SHAr, normal);
	x.g = dot(lmd_unity_SHAg, normal);
	x.b = dot(lmd_unity_SHAb, normal);
...
half3 LMDSHEvalLinearL2(half4 normal)
{
	...
	x1.r = dot(lmd_unity_SHBr, vB);
	x1.g = dot(lmd_unity_SHBg, vB);
	x1.b = dot(lmd_unity_SHBb, vB);

	// Final (5th) quadratic (L2) polynomial
	half vC = normal.x*normal.x - normal.y*normal.y;
	x2 = lmd_unity_SHC.rgb * vC;
...
#ifdef LMDSH
	ambient += max(half3(0, 0, 0), LMDShadeSH9(half4(normal, 1.0)));
#else
	ambient += max(half3(0, 0, 0), ShadeSH9(half4(normal, 1.0)));
#endif
