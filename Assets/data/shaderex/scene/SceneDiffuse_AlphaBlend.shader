Shader "LMD/Scene/Diffuse_AlphaBlend"
{
	Properties
	{
	...
	SubShader
	{
		...
		CGPROGRAM
		#pragma surface surf Battle noforwardadd vertex:vert finalcolor:Fog keepalpha
#pragma multi_compile __ _OUTPUT_BLOOM_DATA
		...
		inline void Fog(Input IN, SurfaceOutput o, inout fixed4 color)
        {
            ...
            color = step(0.95,c.a)*emissive*emissive.a*_BloomIntension;
		// 	color =  step(0.95,c.a)*_BloomIntension;
		    #endif		
        }
		...
		void surf(Input IN, inout SurfaceOutput o) {
			...
			o.Alpha = c.a;
	//		o.Albedo  = step(0.95,c.a);
			o.Emission = emissive*_Emissive*c.a;
		}
		ENDCG
	}
